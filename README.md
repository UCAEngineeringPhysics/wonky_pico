...
1. Download and dive into the repository.
  ...
  git clone https://github.com/ucaengineeringphysics/wonky_pico.git
  cd wonky_pico
  ```

2. Upload motion controller

  ```console
  rshell -p /dev/ttyACM0 --buffer-size 512 cp -r upython_scripts/mobile_control /pyboard/
  ```
